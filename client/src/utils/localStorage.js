...
export const removeFavBookId = (bookId) => {
    ...
    const updatedFavoritedBookIds = favoritedBookIds?.filter((favoritedBookId) => favoritedBookId !== bookId);
    localStorage.setItem('favorited_books', JSON.stringify(updatedFavoritedBookIds));
